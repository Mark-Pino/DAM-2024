import 'package:calc_upeu_tarea/theme/AppTheme.dart';
...
class _CustomAppBarState extends State<CustomAppBar>{
  ...
  Widget build(BuildContext context) {
    int coloS=0;
    return AppBar(
      title: Center(child: AppTheme.useMaterial3 ? const Text("Material 3") : const Text("Calculadora: Mark Roger Pino Chata")),
      actions: [
        IconButton(
